...
public class DrumKit extends MouseAdapter {
    ...
    String DrumimgA = "Drum1.jpg";
    String DrumimgB = "Drum2.jpg";
   	 // 9. Use the "createLabelImage()" method to initialize the drumLabelWithImage variable.
    drumLabelWithImage = createLabelImage(DrumimgA);
   	drumLabelWithImage2 = createLabelImage(DrumimgB);
   	 // 10. Add the image to the panel
    p.add(drumLabelWithImage);
    p.add(drumLabelWithImage2);
